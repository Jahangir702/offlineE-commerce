	...
	products.forEach((p) => {
	  $(".products").append(`
	   ...
	   <div class="product">
            ...
            style="text-align: center; padding: 7px; background-color: cadetblue; color: white; 
            border-radius: 0.25rem; border: solid 1px cadetblue; width: 120px; cursor:pointer;">Add to cart</button>
			</div>
		</div>
